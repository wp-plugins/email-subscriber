...
<tr valign="top">
                    ...
                    <td style="vertical-align:middle;">This is shortcode generator for email subscriber(campaigns) popup box. so you can create unlimited shortcode by createing each custom post <strong>ES Campaign</strong>. By choosing different theme for each different popup box will be amazing experience for visitors.                    
...
<span class="subscribers-hint">Plese use this shortcode to disply email subscriber popup box on your page or php code in theme files</span>
